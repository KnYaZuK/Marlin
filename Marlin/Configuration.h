...
#define STRING_CONFIG_H_AUTHOR "Denis Kobyakin" // Who made the changes.
...
#define DELTA
  ...
  // G33 Delta Auto-Calibration. Enable EEPROM_SETTINGS to store results.
    ...
    #define DELTA_SMOOTH_ROD_OFFSET 168   // (mm)
    // Horizontal offset of the universal joints on the end effector.
    #define DELTA_EFFECTOR_OFFSET 34      // (mm)
    // Horizontal offset of the universal joints on the carriages.
    #define DELTA_CARRIAGE_OFFSET 21.5    // (mm)
  ...
  #define DELTA_HEIGHT 288.40             // (mm) Get this value from G33 auto calibrate
